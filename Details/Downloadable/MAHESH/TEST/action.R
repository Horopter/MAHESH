...
print(paste0("The correlation between actual gross amount and max_predict value is :",cor(n$maxx,m2$gross)))
print(paste0("The correlation between actual gross amount and min_predict value is :",cor(n$minx,m2$gross)))
print(paste0("The correlation between actual gross amount and mean_predict value is :",cor(n$meanx,m2$gross)))
...
pdf(file="predict_max_test.pdf")
	...
	lines(x,z,col="green")
dev.off()
pdf(file="predict_mean_test.pdf")
	y<-b2[,2]
	x<-b2[,1]
	z<-b2[,3]
	plot(x,y,xlab="Movie Ordinal",ylab="Earning in Cr INR")
